package com.jrsolutions.course.config;
...
import com.jrsolutions.course.entities.Payment;
...
import com.jrsolutions.course.repositories.OrderItemRepository;
import com.jrsolutions.course.repositories.OrderRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	//Implementação para o banco de dados teste, para popular o banco de dados
	
	@Autowired  //essa anotação injeta uma dependencia
	private UserRepository userRepository;
	
	@Autowired //injetamos a dependencia do order para poder realizar operações com esse tipo de repository
